...
[![Open Source Love](https://firstcontributions.github.io/open-source-badges/badges/open-source-v1/open-source.svg)](https://github.com/Syntax-Error-Team/Making-Bugs)
...
You can get your own fork/copy of [Making-Bugs](https://github.com/Syntax-Error-Team/Making-Bugs) by using the <a href="https://github.com/Syntax-Error-Team/Making-Bugs"><kbd><b>Fork</b></kbd></a> button.
...
```sh
$ git clone https://github.com/{Your_Username}/Making-Bugs.git
```
...
```sh
$ git remote -v
origin  https://github.com/Your_Username/Making-Bugs.git (fetch)
...
origin    https://github.com/Your_Username/Making-Bugs.git (fetch)
origin    https://github.com/Your_Username/Making-Bugs.git(push)
upstream  https://github.com/Your_Username/Making-Bugs.git (fetch)
upstream  https://github.com/Your_Username/Making-Bugs.git (push)
```
